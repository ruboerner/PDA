...
$$ {#eq-newton}
Diese Gleichung kann für einfache Feldkonfigurationen trivial integriert werden.
Im Falle des geomagnetischen Feldes gibt es keine geschlossenen Lösungen, sondern nur Näherungen. Für Teilchen mit geringer Energie, wie sie bspw. in der Ionosphäre oder im Van-Allen-Gürtel vorliegen, steht eine Theorie zur Approximation bereit.

Zunächst werden wir Lösungen von @eq-newton für vereinfachte Bedingungen betrachten.
Später werden wir sehen, dass im Allgemeinen von den Teilchen eine schnelle Kreisbewegung ausgeführt wird, die überlagert wird durch die Bewegung durch Magnetfelder und elektrische Felder.
...
$$
\dot{\mathbf v}_\perp = \frac{q}{m} \left( \mathbf v_\perp \times \mathbf B \right) = \mathbf \omega_g \times \mathbf v_\perp
$$ {#eq-gyration}
...
$\widehat{\mathbf \omega}_g$ ist der Einheitsvektor der Winkelgeschwindigkeit. Mit der Rechte-Hand-Regel ergibt sich die Bewegungsrichtung.
...
$$
\mathbf v_\perp = \mathbf \omega_g \times \mathbf r_g
$$
Mit $\mathbf r_g$ bezeichnen wir die Teilchenposition. Sie beschreibt eine Kreisbahn mit Radius $r_g$ um den Gyrationsmittelpunkt, der auch als _Führungszentrum_ bezeichnet wird.

### Beispiel
Wir berechnen die Zyklotronfrequenz und den Gyratonsradius für ein Elektron.
