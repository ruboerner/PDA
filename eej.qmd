...
\end{align}
$$
Das Peak der Pedersen-LF beträgt etwa die Hälfte vom Peak der Hall-LF.
Parallelleitfähigkeit $\sigma_{\parallel}$ ist wesentlich größer und erreicht Werte von $\sigma_{\parallel} = 10^{2}$ S/m. In F-Schicht und darüber wird der Wert eines voll ionisierten Plasmas erreicht und wird als Unendlich angenommen.
